...
CREATE INDEX IF NOT EXISTS idx_ne_status ON notification_events(status, created_at);
...
CREATE INDEX IF NOT EXISTS idx_nc_member ON notification_channels(member_id);
...
CREATE INDEX IF NOT EXISTS idx_noti_member ON notifications(member_id, is_read, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_nh_notification ON notification_history(notification_id);
